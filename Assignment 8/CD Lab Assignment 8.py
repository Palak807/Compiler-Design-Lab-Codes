...
def parsingTable(productions, first, follow):
    ...
    for pair in table:
        newTable[pair[1]][pair[0]] = table[pair]
...
if __name__ == "__main__":
    ...
    table = parsingTable(productions, first, follow)
    parse_string = input("Enter the String to be parsed: ")
    check_validity(parse_string, start, table)
